...
public class CurrentAccount : IComparable
{
	...
	{
		// return -1 when Instance precedes 'obj'
		// return 0 when Instance equals to 'obj'
		// return 1 when 'obj' precedes Instance 
		if (obj is not CurrentAccount) return -1;
		var otherAccount = obj as CurrentAccount;
		return Number.CompareTo(otherAccount.Number);
	}
}
